...
export function Skills() {
  ...
  return (
    <section id="skills" className="py-24 px-4 sm:px-6 lg:px-8 bg-warm-beige">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl font-semibold mb-6 text-dark-charcoal">Technical Skills</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          {skillCategories.map((category, index) => (
            <Card key={index} className="border border-light-cream bg-white">
              <CardHeader>
                <CardTitle className="text-lg font-semibold text-dark-charcoal">{category.title}</CardTitle>
              </CardHeader>
              <CardContent>
        ...
        <Card className="border border-light-cream bg-white">
          <CardHeader className="text-center">
            <CardTitle className="text-2xl font-semibold text-dark-charcoal">Professional Certifications</CardTitle>
          ...
          <CardContent>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              {certifications.map((cert, index) => (
                <div key={index} className="border border-light-cream rounded-lg p-4 bg-light-cream">
                  <h4 className="font-semibold text-dark-charcoal mb-1">{cert.name}</h4>
